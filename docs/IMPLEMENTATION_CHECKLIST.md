...
|--------|--------|----------|--------|
| Sprint 1 | Infrastruktur & Fondasi | 85% | 🔄 |
| Sprint 1.5 | Database Fix | 0% | ⬜ |
...
| 1.1.4 | Setup ESLint + Prettier | P1 | ✅ | DevOps | 1h | Done |
| 1.1.5 | Setup Husky pre-commit hooks | P1 | ⬜ | DevOps | 1h | |
...
| 1.2.5 | Docker Secrets untuk credentials | P0 | 🔄 | DevOps | 2h | Partial |
| 1.2.6 | Prometheus monitoring | P2 | ⬜ | DevOps | 2h | Belum ada |
| 1.2.7 | Grafana dashboard | P2 | ⬜ | DevOps | 2h | Belum ada |
...
| 1.3.11 | @sikerma/ui: StepWizard component | P1 | ⬜ | Frontend | 3h | **MISSING** |
...
| 1.3.17 | @sikerma/shared: TypeScript types | P0 | ✅ | Frontend | 4h | |
| 1.3.18 | @sikerma/shared: Zod schemas | P0 | ✅ | Frontend | 3h | |
| 1.3.19 | @sikerma/shared: Constants | P1 | ✅ | Frontend | 1h | |
...
| # | Task | Prioritas | Status | Owner | Est. | Notes |
|---|------|-----------|--------|-------|------|-------|
| 1.5.1.1 | Tambah field eselon_id ke pegawai | P0 | ⬜ | Backend | 0.5h | Migration 05 |
| 1.5.1.2 | Tambah field tmt_cpns, tmt_pns | P0 | ⬜ | Backend | 0.5h | Migration 05 |
| 1.5.1.3 | Tambah field tmt_pangkat_terakhir | P0 | ⬜ | Backend | 0.5h | Migration 05 |
| 1.5.1.4 | Tambah field status_kerja | P0 | ⬜ | Backend | 0.5h | Migration 05 |
| 1.5.1.5 | Perbaiki constraint status_pegawai | P0 | ⬜ | Backend | 0.5h | Migration 05 |
| 1.5.1.6 | Tambah field audit (created_by, updated_by) | P1 | ⬜ | Backend | 0.5h | Migration 05 |

### 1.5.2 New Master Data ⬜

| # | Task | Prioritas | Status | Owner | Est. | Notes |
|---|------|-----------|--------|-------|------|-------|
| 1.5.2.1 | Buat tabel ref_golongan_non_pns | P1 | ⬜ | Backend | 1h | Migration 06 |
| 1.5.2.2 | Seed golongan non-PNS (I, V, IX) | P1 | ⬜ | Backend | 0.5h | Migration 06 |
| 1.5.2.3 | Lengkapi seed jabatan (20+ jabatan) | P0 | ⬜ | Backend | 1h | Migration 07 |

### 1.5.3 Type Updates ⬜

| # | Task | Prioritas | Status | Owner | Est. | Notes |
|---|------|-----------|--------|-------|------|-------|
| 1.5.3.1 | Update TypeScript types di @sikerma/shared | P0 | ⬜ | Frontend | 2h | |
| 1.5.3.2 | Update Zod validation schemas | P0 | ⬜ | Frontend | 2h | |
| 1.5.3.3 | Update backend Go models | P0 | ⬜ | Backend | 2h | |
...
### Key Dependencies
- Sprint 2 requires Sprint 1.5 (database fix)
